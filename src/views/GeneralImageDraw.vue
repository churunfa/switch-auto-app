      ...
      <div v-if="selectedColorIndex >= 0" class="drawing-section">
        ...
        <div class="drawing-panel">
          <div class="drawing-actions">
            <button @click="startDrawing" class="action-button primary large" :disabled="isDrawing">
              🎯 开始绘制
            </button>
            <button v-if="isDrawing" @click="stopDrawing" class="action-button stop large">
              ⏹️ 停止绘制
            </button>
          </div>
...
function simulateDrawing() {
  const interval = setInterval(() => {
    drawingProgress.value += 10;
    if (drawingProgress.value >= 100) {
